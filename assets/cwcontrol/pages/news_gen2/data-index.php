...
$sql .= "WHERE news_Title LIKE '%".$word."%' ";
$sql .=	"ORDER BY news_Sort ASC ";
                            ...
                            <div class="col-lg-6">  
                               ...
                               <form class="form-inline" action="index.php" method="post">
                                  ...
                                  <div class="form-group">                            
                                    ...
                                    <input type="text" class="form-control" name="txtKeyword" placeholder="ค้นหา" value="<?php echo $word;?>">
  ...
  <table class="table table-striped table-bordered table-hover" style="margin-top:10px;">
   ...
   <thead>
    ...
    <tr>
      ...
      <td width="50%" align="center">หัวข้อข่าวสาร</td>

      <td width="20%" align="center">วันที่</td>

      <td width="15%" align="center">สถานะ</td>

      <td width="15%" align="center">เรียงลำดับ</td>
...
<?php
	...
	<tr>
		...
		<td colspan="14" align="center">ไม่พบข้อมูล</td>
 ...
 <td align="center"><input class="ChkBox" type="checkbox" name="checkboxlist"  value="<?php echo $data["news_ID"];?>"></td> 

 <td align="center"><?php echo $data["news_Title"];?></td>

 <td align="center"><?php echo DateThai_timestame($data["news_Date"]);?></td>

 <td align="center">



    <input type="checkbox" class="status" data-size="mini" data-on-color="success" id="<?php echo $data["news_ID"];?>" <?php if($data["news_Status"] == 1){ echo "checked";}?>>
 ...
 <td align="center"><select class="form-control news_Sort" id="<?php echo $data['news_ID'];?>">
...
<option value="<?php echo $t;?>" <?php if($data["news_Sort"] == $t){ echo "selected"; }?> ><?php echo $t;?></option>
...
<?php
 ...
 <td align="center"><a href="index.php?type=edit&id=<?php echo $data["news_ID"]?>"><i class="fa fa-cog" style="color:#333;font-size:1.4em"></i></a></td>

 <td align="center"><a href="#" class="delete" id="<?php echo $data['news_ID'];?>"><i class="fa fa-trash-o" style="color:#333;font-size:1.4em"></i></a></td>
                ...
                ?>
                           ...
                           <!--<div class="row">
                              ...
                              <div class="col-lg-12">
                            	...
                            	<div style="text-align:right; color:#900; margin:5px 0 5px 0; padding-right:20px; padding-bottom:5px; /*border-bottom:solid 1px #d44343;*/">** product   แนะนำเลือกได้เพียง 3 รายการเท่านั้น</div>  
